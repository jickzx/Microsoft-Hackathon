...
function PostQuestModal({
  ...
  const [sourceType, setSourceType] = useState<QuestSourceType>("multi");
      ...
      <section className="post-modal" role="dialog" aria-modal="true" aria-label="Post quest">
        ...
        <div className="post-grid">
          <div className="intake-panel">
            ...
            <label>
              Text or Description (optional)
              <textarea
                value={text}
                onChange={(event) => setText(event.target.value)}
                placeholder="Paste event details, email content, or notes here..."
              />
            </label>
            <label className="file-drop">
              <Upload size={18} />
              <div>
                <strong>{file ? file.name : "Upload Image or Poster (optional)"}</strong>
                <p className="muted">Drag and drop or click to browse</p>
              </div>
              <input
                type="file"
    ...
    <section className="review-form" aria-label="Review extracted quest">
      ...
      <label>
        ...
        <input
          ...
          placeholder="Club, Department, or Individual"
        />
      </label>
      <label>
        Summary
      ...
      <label>
        ...
        <input
          ...
          placeholder="e.g. $50, Pizza, Experience"
        />
      </label>
      <div className="review-field-row">
        <label>
